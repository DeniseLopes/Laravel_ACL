...
class CreatePapelsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('papel-permissao', function (Blueprint $table) {
            ...
            $table->primary(['permissao_id','papel_id']);/*chaves primarias da table papel-permissao*/
        });
        ...
        Schema::create('papel_user', function(Blueprint $table){
            ...
            $table->primary(['papel_id','user_id']); /*chave primaria da table papel_user*/
        });
    }
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('papel-permissao');
